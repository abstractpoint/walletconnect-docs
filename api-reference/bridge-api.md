...
Bridge Server's purpose is to relay requests securely between Dapps and user's Wallet. 

Bridge server also sends push messages to an optional *[Push Server](push-server-api.md)*
